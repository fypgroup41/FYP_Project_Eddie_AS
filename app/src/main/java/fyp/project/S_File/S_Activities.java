...
public class S_Activities extends AsyncTask_Type {
    ...
    public S_Activities(String url, Activity activity, String webpage_output, ArrayAdapter aryAdapter_list, GridView gv, TextView tvOutput, String http_method, String val) {
        super(http_method);
        super.setVal(val);
        this.url = url;
        this.activity = activity;
